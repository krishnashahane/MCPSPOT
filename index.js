...
const setupGlobalProxyFetch = () => {
    const envVars = Object.fromEntries(Object.entries(process.env).filter(([, value]) => typeof value === 'string'));
    ...
    const proxyFetchWithLog = async (input, init) => {
    ...
    globalThis.fetch = proxyFetchWithLog;
