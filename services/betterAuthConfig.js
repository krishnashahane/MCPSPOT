...
export const getBetterAuthRuntimeConfig = () => {
    ...
    const googleEnabled = enabled && Boolean(providerSettings.google?.enabled ?? true) && googleEnvConfigured;
    const githubEnabled = enabled && Boolean(providerSettings.github?.enabled ?? true) && githubEnvConfigured;
...
//# sourceMappingURL=betterAuthConfig.js.map