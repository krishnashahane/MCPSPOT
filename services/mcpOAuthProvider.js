...
/**
 * MCPSpot OAuth Provider for server-side OAuth flows
 *
 ...
 */
export class MCPSpotOAuthProvider {
    constructor(serverName, serverConfig, systemInstallBaseUrl) {
        this.serverName = serverName;
        this.serverConfig = serverConfig;
        this._systemInstallBaseUrl = systemInstallBaseUrl;
    }
    /**
     * Factory method to create an MCPSpotOAuthProvider with async config loading
     */
    static async create(serverName, serverConfig) {
        const systemConfigDao = getSystemConfigDao();
        const systemConfig = await systemConfigDao.get();
        const systemInstallBaseUrl = systemConfig?.install?.baseUrl;
        return new MCPSpotOAuthProvider(serverName, serverConfig, systemInstallBaseUrl);
    }
    ...
    get clientMetadata() {
        ...
        return {
            ...
            client_name: metadata.client_name || `MCPSpot - ${this.serverName}`,
...
export const createOAuthProvider = async (serverName, serverConfig) => {
    ...
    const provider = await MCPSpotOAuthProvider.create(serverName, serverConfig);
