// filepath: /Users/sunmeng/code/github/mcpspot/src/services/logService.ts
...
class LogService {
    ...
    formatLogMessage(type, source, message, processId) {
    ...
    overrideConsole() {
        ...
        const handleConsoleMethod = (type, originalMethod, ...args) => {
    ...
    addLog(type, source, message, processId) {
        const log = {
            timestamp: Date.now(),
            type,
            source,
