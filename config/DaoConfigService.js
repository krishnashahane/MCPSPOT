import { getUserDao, getServerDao, getGroupDao, getSystemConfigDao, getUserConfigDao, } from '../dao/index.js';
/**
...
export function createDaoConfigService() {
    return new DaoConfigService(getUserDao(), getServerDao(), getGroupDao(), getSystemConfigDao(), getUserConfigDao());
}
