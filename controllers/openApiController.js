import { generateOpenAPISpec, getAvailableServers, getToolStats, } from '../services/openApiGeneratorService.js';
...
export const getOpenAPISpec = async (req, res) => {
    try {
        const options = {
            ...
            groupFilter: req.query.group,
            serverFilter: req.query.servers ? req.query.servers.split(',') : undefined,
        };
 ...
 */
export const getOpenAPIServers = async (req, res) => {
    try {
 ...
 */
export const getOpenAPIStats = async (req, res) => {
    try {
 ...
 */
export const executeToolViaOpenAPI = async (req, res) => {
    try {
 ...
 */
export const getServerOpenAPISpec = async (req, res) => {
    try {
        ...
        const options = {
            title: req.query.title || `${name} MCP API`,
            description: req.query.description || `OpenAPI specification for ${name} MCP server tools`,
            version: req.query.version,
            serverUrl: req.query.serverUrl,
            includeDisabledTools: req.query.includeDisabled === 'true',
 ...
 */
export const getGroupOpenAPISpec = async (req, res) => {
    try {
        const { name } = req.params;
        ...
        const options = {
            title: req.query.title || `${group.name} Group MCP API`,
            description: req.query.description || `OpenAPI specification for ${group.name} group tools`,
            version: req.query.version,
            serverUrl: req.query.serverUrl,
            includeDisabledTools: req.query.includeDisabled === 'true',
