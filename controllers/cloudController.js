import { getCloudServers, getCloudServerByName, getCloudServerTools, callCloudServerTool, getCloudCategories, getCloudTags, searchCloudServers, filterCloudServersByCategory, filterCloudServersByTag, } from '../services/cloudService.js';
// Get all cloud market servers
export const getAllCloudServers = async (_, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud market servers';
        res.status(500).json({
            success: false,
...
export const getCloudServer = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud market server';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const getAllCloudCategories = async (_, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud market categories';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const getAllCloudTags = async (_, res) => {
    try {
...
export const searchCloudServersByQuery = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to search cloud market servers';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const getCloudServersByCategory = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud market servers by category';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const getCloudServersByTag = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud market servers by tag';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const getCloudServerToolsList = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to get cloud server tools';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
...
export const callCloudTool = async (req, res) => {
    try {
        ...
        const errorMessage = error instanceof Error ? error.message : 'Failed to call cloud server tool';
        res.status(500).json({
            success: false,
            message: errorMessage,
        });
