 ...
 */
export const checkActivityAvailable = async (req, res) => {
    res.json({
        success: true,
        data: {
...
export const getActivities = async (req, res) => {
    try {
        ...
        if (req.query.keyId) {
            filter.keyId = req.query.keyId;
        }
        if (req.query.keyName) {
            filter.keyName = req.query.keyName;
        }
 ...
 */
export const getActivityFilterOptions = async (req, res) => {
    try {
        const activityDao = getActivityDao();
        if (!activityDao) {
            res.status(404).json({
