...
export class OpenAPIClient {
    ...
    extractTools() {
        ...
        this.tools = [];
        const generatedNames = new Set(); // Used to ensure generated names are unique
        for (const [path, pathItem] of Object.entries(this.spec.paths)) {
            ...
            for (const method of methods) {
                ...
                const tool = {
                    ...
                    inputSchema: this.generateInputSchema(operation, path, method),
    ...
    async callTool(toolName, args, passthroughHeaders) {
