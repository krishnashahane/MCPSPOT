...
import { betterAuthRuntimeConfig, getBetterAuthRuntimeConfig, } from './services/betterAuthConfig.js';
const runtimeConfig = getBetterAuthRuntimeConfig();
const socialProviders = {};
if (runtimeConfig.providers.google.enabled &&
...
if (runtimeConfig.providers.github.enabled &&
...
const resolveBaseURL = (baseUrl, basePath) => {
...
const baseURL = resolveBaseURL(process.env.BETTER_AUTH_URL || `http://localhost:${defaultConfig.port}${defaultConfig.basePath}`, runtimeConfig.basePath);
