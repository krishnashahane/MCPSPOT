...
Smart Routing requires additional setup compared to basic MCPSpot usage:
...
<Tabs>
  ...
  <Tab title="Manual Setup">
    ...
    ```bash
    export DB_URL="postgresql://mcpspot:your_password@localhost:5432/mcpspot"
      ...
      template:
        ...
        spec:
          ...
          - name: mcpspot
            ...
            env:
            - name: DB_URL
              value: "postgresql://mcpspot:password@postgres:5432/mcpspot"
            - name: OPENAI_API_KEY
              valueFrom:
                secretKeyRef:
                  name: openai-secret
  ...
  <Accordion title="Embedding Model Selection">
    ...
    <Info>
      **HNSW is the Recommended Index Type**
      ...
      MCPSpot uses HNSW indexes by default because:
    ...
    <Warning>
      **Vector Dimension Limits (pgvector 0.7.0+)**
      ...
      - MCPSpot automatically uses halfvec casting for optimal indexing
