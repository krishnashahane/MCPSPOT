...
description: 'Configure authentication and security settings for MCPSpot'
---

## Overview

MCPSpot provides flexible authentication mechanisms to secure your MCP server management platform. The system supports multiple authentication methods and role-based access control.
...
```json
{
  "auth": {
    "provider": "database",
    "database": {
      "url": "postgresql://user:pass@localhost:5432/mcpspot",
      "userTable": "users"
    }
  }
}
...
MCPSpot supports role-based access control:
