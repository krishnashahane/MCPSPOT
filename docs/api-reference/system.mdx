...
<Card
  ...
  href="#health-check"
>
  Check the health status of the MCPSpot server.
</Card>
...
**Note**: This endpoint is used internally by MCPSpot's OAuth integration and should not be called directly by clients.
