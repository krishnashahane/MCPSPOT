---
title: "Introduction"
description: "Welcome to the MCPSpot API documentation."
---

The MCPSpot API provides a comprehensive set of endpoints to manage your MCP servers, groups, users, and more. The API is divided into two main categories:
...
- **Management API**: These endpoints are used for managing the MCPSpot instance itself. This includes managing servers, groups, users, and system settings.
