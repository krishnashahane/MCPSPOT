...
description: 'Get MCPSpot running in 5 minutes'
---
...
<Tabs>
  <Tab title="Docker (Recommended)">
    The fastest way to get started with MCPSpot is using Docker:
  ...
  <Tab title="npm Package">
    Install MCPSpot as a global package:
...
Once your servers are configured, connect your AI clients using MCPSpot endpoints:
...
<AccordionGroup>
  <Accordion title="Server won't start">
    ...
    correctly set - Check MCPSpot logs for detailed error messages
  </Accordion>

  <Accordion title="Can't connect from AI client">
    - Ensure MCPSpot is running on the correct port - Check firewall settings - Verify the endpoint
    URL format
  </Accordion>
