...
description: 'Learn how to set up your development environment for MCPSpot'
---

# Getting Started with Development

This guide will help you set up your development environment for contributing to MCPSpot.
...
DB_URL=postgresql://username:password@localhost:5432/mcpspot
